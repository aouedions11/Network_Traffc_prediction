...
class EncoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, seq_len, nodes, device, **model_kwargs):
...
class DecoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx=None, nodes=23, horizon=1, device='cuda:0'):
...
class DCRNNModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, seq_len, nodes, pre_len, device):
        super().__init__()
        Seq2SeqAttrs.__init__(self, adj_mx, nodes)
        self.encoder_model = EncoderModel(adj_mx, seq_len, nodes, device)
        self.decoder_model = DecoderModel(adj_mx, nodes, pre_len, device)
        self.cl_decay_steps = 1000
